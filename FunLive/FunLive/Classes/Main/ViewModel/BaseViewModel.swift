...
extension BaseViewModel {
    ...
    // MARK:- 请求推荐、娱乐模块主播数据
    func loadAnchorData(_ method : MethodType, URLString : String, parameters: [String : Any]? = nil, finishedCallback: @escaping () -> ()) {
    ...
    // MARK:- 请求趣玩模块主播数据
    func loadFunnyData(_ method : MethodType, URLString : String, parameters: [String : Any]? = nil, finishedCallback: @escaping () -> ()) {
